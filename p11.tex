		...
		\begin{enumerate}[a)]
			\item
			      ...
			      \end{tabular}
                    ...
                    Entonces, $N$ = $1001.00011..._{2}$

                    Su representación en notación científica normalizada sería $N$ = $0.1(001000)11..._{2}\times2^{4}$.

                    Haremos el redondeo con ayuda de los paréntesis. Estos separan los lugares de los seis bits que irán a la mantisa. Como el bit que sigue inmediatamente después del séptimo es 1 y luego hay al menos otro 1, el séptimo bit aumenta 1: $N$ = $0.1(001001)_{2}\times2^{4}$

                    Ahora añadimos a la representación el signo y el desplazamiento del exponente (-3):
                    
                    $N$ = $(-1)^0\times0.1(001001)_{2}\times2^{7-3}$

                    Signo: 0
                    Mantisa: 001001
                    Exponente desplazado: 7 = $111_{2}$
                    
			      Por lo tanto, una computadora con redondeo y punto flotante de 10 bits, como se ha descrito, almacena el número 9.123 de esta forma:
