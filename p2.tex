				      ...
				      \begin{itemize}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \right|= \left|0.43257143 - 0.43257\right| = 0.00000143 = 0.143\cdot10^{-5}
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \dfrac{
							            ...
							            \left|
							            \alert{x}
							            \right|}= \dfrac{\left|0.43257143 - 0.43257\right|}{\left|0.43257143\right|} = 0.33058\cdot10{-5}
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \right|=\left|0.43257824 - 0.43258\right| = 0.00000176 = 0.176\cdot10^{-5}
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \dfrac{
							            ...
							            \left|
							            \alert{y}
							            \right|}= \dfrac{\left|0.43257824 - 0.43258\right|}{\left|y\right|} = 0.40686\cdot10^{-5}
					            \end{math}
				      \end{itemize}
			      \end{multicols}
		\end{enumerate}
				      ...
				      \begin{itemize}
					      \item
					            ...
					            \begin{math}
						            ...
						            \operatorname{fl}\left(\alert{x}\right)+
						            \operatorname{fl}\left(\alert{y}\right)
						            \right)= \operatorname{fl}\left(0.86515\right) = 0.86515
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \operatorname{fl}\left(\alert{x}\right)-
						            \operatorname{fl}\left(\alert{y}\right)
						            \right)= \operatorname{fl}\left(-0.00001\right) = -0.00001 = -0.1\cdot10^{-4}
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \operatorname{fl}\left(\alert{y}\right)
						            \right)= \operatorname{fl}\left(0.1871211\right) = 0.18712
					            \end{math}
					      ...
					      \item
					            ...
					            \begin{math}
						            ...
						            \right)= \operatorname{fl}\left(0.99997688\right) = 0.99998
					            \end{math}
				      \end{itemize}
			      \end{multicols}
		\end{enumerate}
				      ...
				      \item
				            ...
				            \begin{math}
					            ...
					            \dfrac{
						            ...
						            \alert{x+y}
						            \right|
					            }=\dfrac{\left|0.86514967-0.86515\right|}{0.86514967} = 0.38144\cdot10^{-6}
				            \end{math}
				      ...
				      \item
				            ...
				            \begin{math}
					            ...
					            \dfrac{
						            ...
						            \alert{x-y}
						            \right|
					            }= \dfrac{\left|-0.00000681+0.00001\right|}{0.00000681} = 0.9319\cdot10^{-4}
				            \end{math}
				      ...
				      \item
				            ...
				            \begin{math}
					            ...
					            \dfrac{
						            ...
						            \alert{x\times y}
						            \right|
					            }=\dfrac{\left|0.18712098786-0.18712\right|}{0.18712098786} = 0.52793\cdot10^{-5}
				            \end{math}
				      ...
				      \item
				            ...
				            \begin{math}
					            ...
					            \dfrac{
						            ...
						            \alert{\dfrac{x}{y}}
						            \right|
					            }= \dfrac{\left|0.99998425718-0.99998\right|}{0.99998425718} = 0.42572\cdot10^{-5}
				            \end{math}
			      \end{itemize}
		\end{enumerate}
	\end{solution}
