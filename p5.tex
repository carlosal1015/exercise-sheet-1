		...
		\begin{enumerate}[a)]
			\item
			      ...
			      \begin{table}[ht!]
				      ...
				      \end{tabular}
			      \end{table}
                Realizaremos la resta de las cifras de la magnitud, dado que las cifras del primer bit significativo son distintas, para ello pondremos abajo la magnitud menor, es decir sin considerar el signo
